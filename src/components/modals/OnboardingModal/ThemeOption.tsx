...
export const ThemeOption = ({ icon, label, selected, value, onSelect }: ThemeOptionProps) => {
  return (
    <button
      ...
      className={`flex h-10 flex-1 items-center justify-center gap-2 rounded-lg border px-3 font-medium text-sm outline-hidden transition-colors focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-inset ${
        selected
